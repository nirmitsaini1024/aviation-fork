...
import RequestForInfo from './pages/dashboard/request-for-information';
      ...
      <Routes>
        ...
        <Route element={<AppLayout user={user} isBotOpen={isBotOpen} setIsBotOpen={setIsBotOpen}/>}>
          ...
          <Route path="/landing-page" element={<CrmDashboard />} />
           <Route path="/request-for-information" element={<RequestForInfo />} />
          ...
          <Route path="/admin-dashboard/index-details" element={<IndexDetails />} />
          <Route path="/admin-dashboard/file-details" element={<FileDetails />} />
